...
const GetReservationsById = () => {
  ...
  const handleFetchById = (event) => {
    ...
    axios.get(`http://localhost:5293/api/Reservation/${reservationId}`)
      .then(response => {
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-center mb-4"> Reservation Details by ID</h2>
      ...
      {/* Display fetched reservation details */}
      {fetchedReservation && (
        <div className="mt-4">
